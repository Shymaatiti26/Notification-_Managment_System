...
export const AuthContextProvider = ({ children }) => {
  ...
  return (
    <AuthContext.Provider value={{ ...state, dispatch, notification,
      ...
      selectedUser,userSocket, setUserSocket,isGroup, setIsGroup,setSelectedUser,users,setUsers,IsAdmin,setAdmin,userSenders,setUsersSenders,muteUser,setMuteUser,showUserChat,setShowUserChat}}>
